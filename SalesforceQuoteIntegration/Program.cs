...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES(@cmid ,'N' ,UPPER(@kcustnum),UPPER(@kcustsrch),UPPER(@custsnum),UPPER(@custname),UPPER(@custadd),UPPER(@custadd01),UPPER(@custadd02),UPPER(@custadd03),UPPER(@custcity),UPPER(@custstate),UPPER(@custzip),UPPER(@custphone),UPPER(@custphon01),UPPER(@custfax),'' ,GETDATE(),'' ,UPPER(@custslsmn),30 ,30 ,30 ,30 ,'T' ,'' ,UPPER(@taxcodes),'' ,'Hi' ,'RC' ,'RC' ,'RC' ,'RC' ,888888888,'' ,0 ,0 ,0 ,0 ,0 ,0 ,0 ,UPPER(@custtxno),NULL ,'' ,@custinsdt,'Tr' ,'' ,'' ,'' ,'' ,'Y' ,'N' ,0.9999 ,'' ,1 ,UPPER(@kcustnum),'' ,'N' ,'Y' ,'N' ,'' ,'' ,'None' ,'Y' ,'No' ,'' ,'' ,'' ,'' ,'' ,'USA' ,'' ,'' ,GETDATE(), '' ,'' ,'' ,'' ,'' ,'' ,'' ,'' ,'USA' ,'' ,'' ,'Ctr' ,'' ,NULL, 'N' ,'' ,'' ,'' ,@custinsamt,'' ,'' ,'' ,'' ,'N' ,NULL ,'N' ,'')
